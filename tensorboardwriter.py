...
def write_threshold_class(writer, best_threshold_dict, best_val_dict, class_list, dic):
    ...
    for c in class_list:
        ...
        if current_freq == freq:
            ...
            if current_count != 0: writer.add_scalars('threshold/threshold_frequency', {"Threshold": current_thres/current_count, "Validation": current_val/current_count}, dic[c-1])
