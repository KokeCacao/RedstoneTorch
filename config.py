...
TRAIN_RESUME = True
TRAIN_NUMCLASS = 28
TRAIN_COSINE = lambda global_step: (0.1 / 2) * (np.cos(np.pi * (np.mod(global_step, 20 * 46808 / 32) / (20 * 46808 / 32))) + 1)  # y=(0.01/2)*(cos(pi*(mod(x-1,10000)/(10000)))+1)
TRAIN_TRY_LR = False
...
PREDICTION_CHOSEN_THRESHOLD = [0.0107, 0.02, 0.1, 0.5]
