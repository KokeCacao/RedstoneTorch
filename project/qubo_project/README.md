...
python train.py --projecttag second --versiontag 23d1a59e --loaddir 2019-01-30-20-31-05-899748-second --loadfile 23d1a59e-CP46_F[1]_PTsecond_VT23d1a59e_LR0.1_BS32_IMG224.pth --resume True
```