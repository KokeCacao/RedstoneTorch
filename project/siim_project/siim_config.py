...
MODEL_INIT_LEARNING_RATE = 0.01 # this is useless for lr_schedulers
# MODEL_LR_SCHEDULER_REDUCE_FACTOR = 0.5
# MODEL_LR_SCHEDULER_PATIENT = 0
MODEL_LR_SCHEDULER_BASELR = 0.01
...
EVAL_TRY_THRESHOLD = np.linspace(0.9, 1.0, 100)
EVAL_THRESHOLD = 0.973
