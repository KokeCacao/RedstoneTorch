...
class AttentionInceptionV3(nn.Module):
    def __init__(self, num_classes=28, attention_size=8, aux_attention_size=8):
        super(AttentionInceptionV3).__init__()
        self.num_classes = num_classes
        ...
        self.cnn.Conv2d_1a_3x3.conv = nn.Conv2d(in_channels=3,  # edit channels
...
def get_resnet34(num_classes=28, **_):
    ...
    conv1 = model.conv1
    model.conv1 = nn.Conv2d(in_channels=3,  # edit channels
...
def get_senet(model_name='se_resnext50', num_classes=28, **_):
    ...
    model.layer0.conv1 = nn.Conv2d(in_channels=3,  # edit channels
                                   out_channels=conv1.out_channels,
                                   kernel_size=conv1.kernel_size,
                                   stride=conv1.stride,
                                   padding=conv1.padding,
