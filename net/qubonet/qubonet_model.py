"""
ResNet model gently borrowed from
...
__all__ = ['SENet', 'se_resnext101_32x4d_modified']

class SEModule(nn.Module):

    def __init__(self, channels, reduction):
        super(SEModule, self).__init__()
        # change self.avg_pool = nn.AdaptiveAvgPool2d(1) to avg pooling
...
def se_resnext101_32x4d_modified(num_classes=1000, pretrained='imagenet'):
    ...
    if pretrained is not None:
        modified_initialize_pretrained_model(model, u'http://data.lip6.fr/cadene/pretrainedmodels/se_resnext101_32x4d-3b2fe3d8.pth')
    return model